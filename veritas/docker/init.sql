-- ============================================
-- APERTURE PROTOCOL — Database Schema Init
...
CREATE TABLE IF NOT EXISTS facts (
  ...
  domain TEXT NOT NULL CHECK (domain IN ('financial', 'logistics', 'agricultural', 'maritime-logistics', 'energy', 'infrastructure')),
  location_name TEXT,
  latitude FLOAT,
  longitude FLOAT,
  image_url TEXT,
...
-- Insert the default signal weights row
INSERT INTO signal_weights (id) VALUES (1) ON CONFLICT (id) DO NOTHING;

-- 8. Semantic Search Function (pgvector cosine similarity)
